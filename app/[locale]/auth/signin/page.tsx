      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-muted/30">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-3xl font-bold text-foreground tracking-tight">{t('welcomeBack')}</h2>
          ...
          {/* Success Message */}
          {showSuccess && (
            <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg text-green-700 dark:text-green-400 text-sm flex items-start gap-3">
